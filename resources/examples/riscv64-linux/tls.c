...
//
// TLS model notes:
//   local-exec  -- offset from thread pointer is materialized with
...
//   initial-exec -- offset is typically loaded through the GOT for symbols that
//                 may be resolved by the dynamic linker.
...
//         RISC-V TPREL HI20/ADD/LO12 relocation sequence):
